...
export function renderTemplate(body: string, vars: TemplateVars): string {
  ...
  const src = vars.link ? body : body.replace(/\s*[^.!?]*:\s*\{\{\s*link\s*\}\}/g, "");
  return src
...
export const DEFAULT_TEMPLATES: DefaultTemplate[] = [
  { key: "recibido", name: "Vehículo recibido", status: "RECEIVED", body: "Hola {{cliente}}, recibimos su {{vehiculo}} (placa {{placa}}) en {{taller}}. Su número de orden es {{orden}}. Puede seguir el avance aquí: {{link}}" },
  { key: "inspeccion", name: "Inspección completada", status: "INSPECTION", body: "Hola {{cliente}}, ya realizamos la inspección inicial de su {{vehiculo}}. Seguimos con el diagnóstico. Avance: {{link}}" },
  { key: "diagnostico", name: "Diagnóstico listo", status: "AWAITING_QUOTE", body: "Hola {{cliente}}, el diagnóstico de su {{vehiculo}} está listo. En breve le enviamos la cotización. Detalles: {{link}}" },
  ...
  { key: "cotizacion_aprobada", name: "Cotización aprobada", status: "APPROVED", body: "Hola {{cliente}}, gracias por aprobar la cotización. Ya programamos la reparación de su {{vehiculo}}. Avance: {{link}}" },
  { key: "reparacion", name: "Reparación iniciada", status: "IN_REPAIR", body: "Hola {{cliente}}, iniciamos la reparación de su {{vehiculo}}. Puede seguir el avance aquí: {{link}}" },
  { key: "repuesto", name: "Esperando repuesto", status: "WAITING_PARTS", body: "Hola {{cliente}}, estamos esperando un repuesto para continuar con su {{vehiculo}}. Le avisamos apenas llegue. Avance: {{link}}" },
  { key: "calidad", name: "Control de calidad", status: "QUALITY_CONTROL", body: "Hola {{cliente}}, su {{vehiculo}} está en control de calidad, el último paso antes de la entrega. Avance: {{link}}" },
  { key: "listo", name: "Vehículo listo", status: "READY", body: "Hola {{cliente}}, ¡su {{vehiculo}} ya está listo para ser retirado en {{taller}}! Puede consultar los detalles aquí: {{link}}" },
